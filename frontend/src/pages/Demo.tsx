      ...
      <div className="flex h-full flex-col bg-canvas">
        ...
        {phase === "goal" ? (
          <main className="slim-scroll relative flex-1 overflow-y-auto">
            ...
            <div className="pointer-events-none absolute inset-0 bg-grid-pattern opacity-60 [mask-image:radial-gradient(ellipse_at_center,black_50%,transparent_90%)]" />
            <div className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 w-[720px] h-[380px] rounded-full bg-gradient-to-tr from-brand-500/15 via-emerald-400/20 to-teal-300/15 blur-3xl opacity-80" />
            
            <div className="relative mx-auto flex min-h-full max-w-3xl flex-col justify-center px-4 py-8 sm:px-6 sm:py-12">
              <ErrorBanner error={error} onDismiss={dismissError} className="mb-6 w-full" />
